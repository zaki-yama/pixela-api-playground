...
export default function DecrementPixel() {
  const {
    register,
    handleSubmit,
    getValues,
  ...
  const onSubmit = async () => {
    ...
    try {
      const response = await decrementPixel(username, token, graphId);
  ...
  return (
    <Layout>
      ...
      <chakra.p py="4">
        Decrement quantity &quot;Pixel&quot; of the day (it is used
